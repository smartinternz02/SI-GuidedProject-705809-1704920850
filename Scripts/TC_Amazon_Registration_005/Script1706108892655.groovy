...
WebUI.setText(findTestObject('Object Repository/Amazon_Registration_OR/Page_Amazon Registration/input_customerName'), 'Rohan')

WebUI.setText(findTestObject('Object Repository/Amazon_Registration_OR/Page_Amazon Registration/input_email'), 'kotar91449@trackden.com')
